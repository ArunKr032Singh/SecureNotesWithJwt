...
import com.nontech.SecurityWithJwt.jwt.AuthEntryPointJwt;
import com.nontech.SecurityWithJwt.jwt.AuthTokenFilter;
    ...
    public CommandLineRunner initData(RoleRepo roleRepository, UserRepo userRepository,PasswordEncoder passwordEncoder) {
        return args -> {
            ...
            if (!userRepository.existsByUserName("user")) {
                User user1 = new User("user", "user@example.com", passwordEncoder.encode("0000000"));
            ...
            if (!userRepository.existsByUserName("admin")) {
                User admin = new User("admin", "admin@example.com", passwordEncoder.encode("1111111"));
